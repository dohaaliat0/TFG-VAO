            ...
            <form action="{{ route('torneos.update', $torneo) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="fecha_inicio" id="fecha_inicio" value="{{ old('fecha_inicio', $torneo->fecha_inicio->format('Y-m-d')) }}"
                    ...
                    <div>
                        ...
                        <input type="date" name="fecha_fin" id="fecha_fin" value="{{ old('fecha_fin', $torneo->fecha_fin->format('Y-m-d')) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="num_grupos" id="num_grupos" value="{{ old('num_grupos', $torneo->num_grupos) }}" min="1"
                    ...
                    <div>
                        ...
                        <input type="number" name="num_categorias" id="num_categorias" value="{{ old('num_categorias', $torneo->num_categorias) }}" min="1"
