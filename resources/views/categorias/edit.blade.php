                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('categorias.update', $categoria) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $categoria->nombre) }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <select id="torneo_id" name="torneo_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                                ...
                                @foreach ($torneos as $torneo)
                                    <option value="{{ $torneo->id }}" {{ old('torneo_id', $categoria->torneo_id) == $torneo->id ? 'selected' : '' }}>
                                        {{ $torneo->nombre }}
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="descripcion" id="descripcion" rows="3" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('descripcion', $categoria->descripcion) }}</textarea>
